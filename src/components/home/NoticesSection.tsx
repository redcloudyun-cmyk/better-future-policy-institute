...
import { Megaphone, ChevronRight, ArrowRight } from "lucide-react";

export default function NoticesSection() {
  return (
    <section className="py-10 md:py-12 bg-[#F1F5F9] border-b border-slate-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#0B2D52] text-teal-300 flex items-center justify-center font-bold shadow-xs">
        ...
        <div className="bg-white rounded-2xl p-5 sm:p-7 border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-5 hover:shadow-md transition-shadow">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#0B2D52] hover:bg-[#061B33] text-white text-xs font-extrabold rounded-xl shadow transition-colors shrink-0"
          >
            <span>공시문 전문 보기</span>
